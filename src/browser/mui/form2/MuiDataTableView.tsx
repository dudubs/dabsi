...
import {
  MuiTableColumn,
  MuiTableColumnProps,
} from "../MuiTable/MuiTableColumn";
import { LangKey } from "./LangKey";
import {
  MuiDataTableAction,
  MuiDataTableActionProps,
} from "./MuiDataTableAction";
...
export type MuiDataTableViewProps<
  ...
  RowController extends AnyRpc = WidgetType<C>["RowController"]
  ...
  columns?: PartialUndefinedKeys<
    {
      [K in keyof Required<Row>]:
        | undefined
        | MuiDataTableViewColumnProps<C, Row[K]>;
    }
  >;

  onEditClick?(event: MuiDataTableActionEvent<C, RowController>): void;

  onDeleteClick?(event: MuiDataTableActionEvent<C, RowController>): void;
  actions?: MuiDataTableActionProps<
    MuiDataTableActionEvent<C, RowController>
  >[];
