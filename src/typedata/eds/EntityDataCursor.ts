...
import { DataQuery } from "../../typeorm/DataQueryExp";
import { DataExpTranslatorToQeb } from "../../typeorm/exp/DataExpTranslatorToQeb";
import {
  DataQueryBuilder,
  DataQueryBuilderOld,
} from "../../typeorm/DataQueryBuilder";
...
export namespace EntityDataCursor {
  ...
  export function createDataQueryBuilder(
    cursor: EntityDataCursor
  ): DataQueryBuilderOld {
    const { repository } = cursor;
    const qb = new DataQueryBuilderOld(repository.metadata.connection, {
