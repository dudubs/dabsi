...
import { AbstractDataSource, DataKeyOrKeys } from "./DataSource/DataSource";
...
export type RemoteDataSourceMethod = Extract<
  keyof DataSource<any>,
  keyof {
    has;
    count;
    items;
...
export type RemoteDataSourceActions<T> = Pick<
  DataSource<T>,
...
export class RemoteDataSourceConnection<T> extends AbstractDataSource<T> {
  constructor(
