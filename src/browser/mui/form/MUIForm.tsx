...
import { ReactNode, Ref, useContext, useRef } from "react";
...
import { MuiDialogOld, MuiDialogProps } from "./MuiDialog";
...
export type MuiFormButtonProps = AssignKeys<
  MuiButtonProps,
  {
...
export function MuiFormButton({ onClick, ...props }: MuiFormButtonProps) {
