...
import { Awaitable, PluckRequired } from "../common/typings";
...
export type RouterContextType<Router> = PluckRequired<Router, "contextType">;

export type RouterContextLoader<Params, Context> = (
  params: Params
) => Awaitable<Context>;

export type RouterContextPacker<Params, Context> = (context: Context) => Params;
