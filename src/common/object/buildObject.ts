import {ExcludeKeys, ExtractKeys} from "../typings";
import {entries} from "./entries";


export type Builder<T> = (prev: T) => T;

export type ValueOrBuilder<T> =

    Exclude<T,Builder<any>> | Builder<T>;
...
export function buildObjectProps<T>(
    props: T,
    keyToBuilder: PropsBuilder<T>
) {
...
export function _buildObject<T>(
    obj: T,
